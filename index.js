...
var data_source_1 = require("./src/dao/data-source");
var Express = require("express");
var produtosRoutes_1 = require("./src/routes/produtosRoutes");
var app = Express();
var cors = require("cors");
var ExpressSession = require("express-session");
var autenticacaoRoutes_1 = require("./src/routes/autenticacaoRoutes");
...
data_source_1.AppDataSource.initialize().then(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Master(process.env.ADMIN, process.env.ADMIN_EMAIL)];
            case 1:
                _a.sent();
